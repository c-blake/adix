...
var olNumer*       = 2 ## default numerator for lg(n) probe depth limit
var olDenom*       = 1 ## default denominator for lg(n) probe depth limit
...
template withItem*[A](s: OLSet[A], itm: A; it,body1: untyped; body2: untyped=nil) =
  mixin rawGet
  let i = s.rawGet(itm)
  if i >= 0:
