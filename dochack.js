/* Generated by the Nim Compiler v2.0.16 */
var framePtr = null;
var excHandler = 0;
...
function HEX24_385875982(xHEX60gensym0_385875983) {
  var result_385875984 = [[]];

    result_385875984[0] = nimCopy(null, [], NTI33554449);
    addInt_301990129(result_385875984, 0, xHEX60gensym0_385875983);
...
function raiseIndexError(i_33556812, a_33556813, b_33556814) {
    ...
    Temporary1 = ([105,110,100,101,120,32] || []).concat(HEX24_385875982(i_33556812) || [],[32,110,111,116,32,105,110,32] || [],HEX24_385875982(a_33556813) || [],[32,46,46,32] || [],HEX24_385875982(b_33556814) || []);
    }
...
function toToc_570425755(x_570425756, father_570425757) {
    ...
    Label1: {
        ...
        if (!(i_570425766 < x_570425756.childNodes.length)) break Label2;
          ...
          Label9: {
            ...
            colontmp__570426552 = it_570425781.childNodes.length;
            var i_570426553 = 0;
            Label10: {
                Label11: while (true) {
                if (!(i_570426553 < colontmp__570426552)) break Label11;
                  j_570425786 = i_570426553;
    ...
    Label12: {
      ...
      colontmp__570426556 = x_570425756.childNodes.length;
      var i_570426557 = 0;
      Label13: {
          Label14: while (true) {
          if (!(i_570426557 < colontmp__570426556)) break Label14;
            i_570425809 = i_570426557;
    ...
    Label16: {
      ...
      colontmp__570426560 = it_570425826.childNodes.length;
      var i_570426561 = 0;
      Label17: {
          Label18: while (true) {
          if (!(i_570426561 < colontmp__570426560)) break Label18;
            j_570425831 = i_570426561;
    ...
    father_570425757.kids.push(e_570425825);;
      ...
      Label19: {
        ...
        colontmp__570426564 = x_570425756.childNodes.length;
        var i_570426565 = 0;
        Label20: {
            Label21: while (true) {
            if (!(i_570426565 < colontmp__570426564)) break Label21;
              i_570425840 = i_570426565;
...
function uncovered_570425944(x_570425945) {
  ...
  BeforeRet: {
    ...
    Label2: {
      ...
      var i_570426593 = 0;
      var L_570426594 = (x_570425945.kids).length;
      Label3: {
          Label4: while (true) {
          if (!(i_570426593 < L_570426594)) break Label4;
            k_570425961 = x_570425945.kids[chckIndx(i_570426593, 0, (x_570425945.kids).length - 1)];
            ...
            i_570426593 += 1;
            if (!(((x_570425945.kids).length == L_570426594))) {
            failedAssertImpl_268435541(makeNimstrLit("iterators.nim(254, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
  ...
  var result_570425977 = null;
    ...
    result_570425977 = news_570425976;
      ...
      Label1: {
        ...
        colontmp__570426589 = (news_570425976.kids).length;
        var i_570426590 = 0;
        Label2: {
            Label3: while (true) {
            if (!(i_570426590 < colontmp__570426589)) break Label3;
              i_570425989 = i_570426590;
...
function buildToc_570425994(orig_570425995, types_570425996, procs_570425997) {
  var result_570425998 = null;
    ...
    Label1: {
      ...
      var i_570426581 = 0;
      var L_570426582 = (types_570425996).length;
      Label2: {
          Label3: while (true) {
          if (!(i_570426581 < L_570426582)) break Label3;
            t_570426007 = types_570425996[chckIndx(i_570426581, 0, (types_570425996).length - 1)];
            ...
            Label4: {
              ...
              var i_570426578 = 0;
              var L_570426579 = (procs_570425997).length;
              Label5: {
                  Label6: while (true) {
                  if (!(i_570426578 < L_570426579)) break Label6;
                    p_570426016 = procs_570425997[chckIndx(i_570426578, 0, (procs_570425997).length - 1)];
                    ...
                    i_570426578 += 1;
                    if (!(((procs_570425997).length == L_570426579))) {
                    failedAssertImpl_268435541(makeNimstrLit("iterators.nim(254, 11) `len(a) == L` the length of the seq changed while iterating over it"));
                    }
            ...
            i_570426581 += 1;
            if (!(((types_570425996).length == L_570426582))) {
            failedAssertImpl_268435541(makeNimstrLit("iterators.nim(254, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
...
function HEX5BHEX5D_738198811(s_738198814, x_738198815) {
  var result_738198816 = [];
    ...
    Label1: {
      ...
      Label2: {
          Label3: while (true) {
          if (!(i_570426607 < L_738198820)) break Label3;
            i_738198825 = i_570426607;
...
function HEX2EHEX2E_973078633(a_973078636, b_973078637) {
  var result_973078640 = ({a: 0, b: 0});

    result_973078640 = nimCopy(result_973078640, {a: a_973078636, b: b_973078637}, NTI973078613);
...
async function loadIndex_570426272() {
  ...
  BeforeRet: {
    ...
    var rootURL_570426306 = HEX5BHEX5D_738198811(cstrToNimstr(indexURL_570426280), HEX2EHEX2E_973078633(0, 14));
...
function escapeCString_570426095(x_570426096, x_570426096_Idx) {
    ...
    Label1: {
      var c_570426098 = 0;
      var iHEX60gensym13_570426624 = 0;
      var nHEX60gensym13_570426625 = ((x_570426096[x_570426096_Idx]) == null ? 0 : (x_570426096[x_570426096_Idx]).length);
      Label2: {
          Label3: while (true) {
          if (!(iHEX60gensym13_570426624 < nHEX60gensym13_570426625)) break Label3;
            c_570426098 = x_570426096[x_570426096_Idx].charCodeAt(chckIndx(iHEX60gensym13_570426624, 0, (x_570426096[x_570426096_Idx]).length - 1));
            switch (c_570426098) {
            case 60:
...
function HEX3Aanonymous_570426127(a_570426132, b_570426133) {
      var result_570426140 = 0;
        ...
        result_570426140 = subInt(b_570426133["Field1"], a_570426132["Field1"]);
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      colontmp__570426611 = (db_570426093[0]).length;
      var i_570426612 = 0;
      Label2: {
          Label3: while (true) {
          if (!(i_570426612 < colontmp__570426611)) break Label3;
            i_570426118 = i_570426612;
            Label4: {
    ...
    Label5: {
      ...
      colontmp__570426615 = nimMin((matches_570426110).length, 29);
      var i_570426616 = 0;
      Label6: {
          Label7: while (true) {
          if (!(i_570426616 < colontmp__570426615)) break Label7;
            i_570426157 = i_570426616;
            ...
            escapeCString_570426095(matches_570426110[chckIndx(i_570426157, 0, (matches_570426110).length - 1)]["Field0"], "innerHTML");
            add_570425492(ul_570426105, tree_570425474("LI", [matches_570426110[chckIndx(i_570426157, 0, (matches_570426110).length - 1)]["Field0"]]));
...
function wrapper_570426435() {
        ...
        var results_570426441 = dosearch_570426099(value_570426437);
